...
Usage of this script:
  python train_param_optim_AttLSTM.py <dataset> <method> <classifier> <params_str> <results_dir>
"""
import time
import os
import pandas as pd
...
if n_layers == 1:
    rnn1 = LSTM(nnsize, input_shape=(max_len, data_dim),implementation=2, kernel_initializer='glorot_uniform', return_sequences=True,
                     dropout=dropout)
    model.add(rnn1)
    ...
    model.add(LSTM(nnsize,input_shape=(max_len, data_dim), implementation=2, kernel_initializer='glorot_uniform',
