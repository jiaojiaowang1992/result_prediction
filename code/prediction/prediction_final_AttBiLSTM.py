...
if n_layers == 1:
    rnn1 = LSTM(lstmsize, implementation=2, kernel_initializer='glorot_uniform', return_sequences=True,
                     dropout=dropout)
    model.add(keras.layers.Bidirectional(rnn1, input_shape=(max_len, data_dim)))
