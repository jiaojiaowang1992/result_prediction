...
if n_layers == 1:
    lstm1 = LSTM(rnnsize, implementation=2, kernel_initializer='glorot_uniform',return_sequences=False, dropout=dropout)
    model.add(keras.layers.Bidirectional(lstm1,input_shape=(max_len, data_dim)))
    model.add(BatchNormalization())

elif n_layers == 2:
    model.add(keras.layers.Bidirectional(LSTM(rnnsize, implementation=2, kernel_initializer='glorot_uniform',
